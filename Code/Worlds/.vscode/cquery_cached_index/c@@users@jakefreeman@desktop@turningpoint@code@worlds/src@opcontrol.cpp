...
void opcontrol()
{
    ...
    LineSensor line2(ADILineSensor(7));
		...
		Drivetrain train(pros::Motor(FRONTRIGHT, true), pros::Motor(FRONTLEFT), pros::Motor(BACKRIGHT, true), pros::Motor(BACKLEFT), Gyroscope(pros::ADIGyro(5), pros::ADIGyro(6)));
