...
vex::motor FrontLeft = vex::motor(vex::PORT7, vex::gearSetting::ratio18_1, false);
...
vex::motor Shooter = vex::motor(vex::PORT5, vex::gearSetting::ratio36_1, false);
vex::motor ShooterAux = vex::motor(vex::PORT9, vex::gearSetting::ratio36_1, true);
